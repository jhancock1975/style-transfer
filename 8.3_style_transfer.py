...
Original file is located at
    https://colab.research.google.com/github/fchollet/deep-learning-with-python-notebooks/blob/master/8.3-neural-style-transfer.ipynb
"""
...
target_image_path = 'turtle.png'
# This is the path to the style image.
style_reference_image_path = 'wave.png'
...
loss.assign_add(content_weight * content_loss(target_image_features,
